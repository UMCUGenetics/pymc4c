...
TARGETFA=$BASEDIR/data/splitbowq_${EXPNAME}_$SGE_TASK_ID.fa
TARGETBT=$BASEDIR/data/splitbowq_${EXPNAME}_$SGE_TASK_ID
PRIMERFA=$BASEDIR/local/${EXPNAME}.fa
TARGETSAM=$BASEDIR/data/splitbowq_${EXPNAME}_$SGE_TASK_ID.sam
